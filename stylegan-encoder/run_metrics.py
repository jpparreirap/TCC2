...
def main():
    ...
    metrics = []
    #metrics += [metric_base.fid50k] OK
    #metrics += [metric_base.ppl_zfull] OK
    #metrics += [metric_base.ppl_wfull] OK
    metrics += [metric_base.ppl_zend]
    #metrics += [metric_base.ppl_wend] OK
    #metrics += [metric_base.ls] OK
    ...
    #tasks += [EasyDict(run_func_name='run_metrics.run_snapshot', 0run_id=100, snapshot=25000)]
